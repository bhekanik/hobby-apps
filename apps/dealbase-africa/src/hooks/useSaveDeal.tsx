...
export function useSaveDeal(onClose: () => void): Omit<
  UseMutationResult<ResultType<Deal>, unknown, DealFromForm, unknown>,
  "mutate"
> & {
  saveDeal: UseMutateFunction<ResultType<Deal>, unknown, DealFromForm, unknown>;
} {
  ...
  const { mutate, ...rest } = useMutation(
    ...
    },
    {
      onSuccess: async () => {
        ...
        toast({
          title: "Successfully saved deal.",
          description: `The new deal has been saved.`,
          status: "success",
          duration: 9000,
          isClosable: true,
          position: "top",
