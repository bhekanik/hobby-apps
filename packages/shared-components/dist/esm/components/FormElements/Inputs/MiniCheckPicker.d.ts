...
export declare const MiniCheckPicker: ({ label, data, noBorder, icon, flex, value, defaultValue, onClean, onChange, placeholder, isGrouped, ...otherProps }: PropsWithChildren<Props & LabelProps>) => JSX.Element;
