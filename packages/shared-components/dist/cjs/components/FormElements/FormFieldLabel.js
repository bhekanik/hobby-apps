...
const FormFieldLabel = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)(react_1.Text, Object.assign({}, rest, { w: w || width || "30%", minW: minW || minWidth || "max-content", color: color || colorMode === "dark" ? "gray.400" : "gray.700" }, { children: children })));
};
