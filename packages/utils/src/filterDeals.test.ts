    ...
    expect(filteredDeals).toEqual([
      {
        ...
        company: {
          ...
          about:
            "Kenyan last-mile end-to-end supply chain and distribution platform.",
          logo_id: 1155,
          sector: "[]",
          logo: {
            id: 1155,
      ...
      },
      {
        ...
        company: {
          ...
          about:
            "Leader of solar PV installation for commercial and industrial use in East Africa",
          logo_id: 1993,
          sector: "[]",
          logo: {
            id: 1993,
      ...
      },
      {
        ...
        company: {
          ...
          about:
            "Paymee offers online payment acceptance solutions to online merchants.",
          logo_id: 1994,
          sector: "[]",
          logo: {
            id: 1994,
      ...
      },
      {
        ...
        company: {
          ...
          about:
            "Baobab+ is a social enterprise that acts in the areas of access to PAYG solar energy and digital products.",
          logo_id: 2123,
