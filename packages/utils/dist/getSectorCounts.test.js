...
import { getFormattedSectorCounts, getSectorCounts, getSectors, } from "./getSectorCounts";
describe("getSectorCounts", () => {
    ...
    it("should return the correct formatted sector counts", () => {
        expect(getFormattedSectorCounts(deals)).toEqual("Agritech: 3, Web3 & Blockchain: 2, Transport & Logistics: 2, Energy & Climatetech: 2, Insuretech: 2, Cleantech & Waste Management: 1, E-Commerce: 1");
        expect(getFormattedSectorCounts([])).toEqual("Unknown");
    });
});
//# sourceMappingURL=getSectorCounts.test.js.map